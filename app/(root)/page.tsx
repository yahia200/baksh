...
async function page() {
  const description = `Bikoon fih 4-* zomala w 2-3 3omala f el le3ba w el hadaf enoko t7beso ai
   7ad men el 3omala.`

  return (
    <div className='h-screen pt-44 space-y-4'>
      <h1 className='w-fit mx-auto sm:text-8xl xs:text-7xl mb-8'>BAKSH</h1>
